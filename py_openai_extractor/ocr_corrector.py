...
class QwenOcrProcessor(AbstractOpenAiChatAgent):
    def __init__(self):
        ...
        self._user_message = (
            ...
            "originales más que al texto extraído, ya que suelen ser mal reconocidos por el OCR.\n\n "
            "# Output Format\n\n"
            "El texto debe ser presentado como un bloque legible y ordenado, sin explicaciones ni anotaciones "
            "adicionales. Asegúrate de que el contenido final sea una representación fiel de los documentos "
            "originales.\n\n "
            "# Notes\n\n"
